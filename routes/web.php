...
Route::post('/alunos/destroy', [AlunoController::class, 'destroy'])->name('alunos.destroy');
...
Route::post('/comprovantes/destroy', [ComprovanteController::class, 'destroy'])->name('comprovantes.destroy');
...
Route::post('/cursos/destroy', [CursoController::class, 'destroy'])->name('cursos.destroy');
...
Route::post('/declaracoes/destroy', [DeclaracaoController::class, 'destroy'])->name('declaracoes.destroy');
...
Route::post('/documentos/destroy', [DocumentoController::class, 'destroy'])->name('documentos.destroy');
...
Route::post('/niveis/destroy', [NivelController::class, 'destroy'])->name('niveis.destroy');
...
Route::post('/turmas/destroy', [TurmaController::class, 'destroy'])->name('turmas.destroy');
